...
\begin{itemize}
    ...
    % \item Integrated services with data brokers for fraud detection and identity verification
...
\begin{itemize}
    % \item Architected and modeled a new messaging, informational and error service
